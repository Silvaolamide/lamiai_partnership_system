...
{
    protected $fillable = ['order_number','customer_id','customer_name','customer_email','customer_phone','program_id','partner_id','business_payout_id','subtotal','discount','total','platform_fee_percent','platform_fee_amount','business_net_amount','currency','status','payment_method','payment_provider','payment_reference','paid_at','refunded_at'];
    protected $casts = ['subtotal'=>'decimal:2','discount'=>'decimal:2','total'=>'decimal:2','platform_fee_percent'=>'decimal:4','platform_fee_amount'=>'decimal:2','business_net_amount'=>'decimal:2','paid_at'=>'datetime','refunded_at'=>'datetime'];
