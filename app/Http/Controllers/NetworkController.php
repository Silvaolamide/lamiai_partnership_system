...
class NetworkController extends Controller
{
    public function index(Request $request)
    {
        ...
        // For super admins, validate the requested root against the already-
        // authorized partner collection. This prevents a crafted query string
        // from exposing another business's network.
        $selectedPartner = null;
        if ($selectedPartnerId && $user->hasRole('super_admin')) {
