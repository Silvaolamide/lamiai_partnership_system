...
class PaymentController extends Controller
{
    ...
    public function proof(PaymentSubmission $payment){ abort_unless($payment->proof_path,404); $disk=Storage::disk('public'); abort_unless($disk->exists($payment->proof_path),404); return response()->file($disk->path($payment->proof_path)); }
