    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-12 mb-8 card-hover">
        ...
        <div class="grid sm:grid-cols-2 gap-4 mb-10 p-6 bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl">
            <div class="flex gap-3">
                ...
                <div>
                    <h3 class="font-semibold text-gray-900">Professional Techniques</h3>
                    <p class="text-sm text-gray-600">Industry-standard filmmaking practices</p>
                </div>
            </div>
            <div class="flex gap-3">
                <div class="flex-shrink-0">
                    <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-100">
                        <svg class="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                    </div>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900">AI-Powered Tools</h3>
                    <p class="text-sm text-gray-600">Cutting-edge editing technology</p>
                </div>
            </div>
            <div class="flex gap-3">
                <div class="flex-shrink-0">
                    <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-purple-100">
                        <svg class="w-6 h-6 text-purple-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                    </div>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900">Monetization Strategies</h3>
                    <p class="text-sm text-gray-600">Turn creativity into income</p>
                </div>
            </div>
            <div class="flex gap-3">
                <div class="flex-shrink-0">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Build your portfolio</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid sm:grid-cols-2 gap-8 sm:gap-12 items-center py-8 border-y border-gray-200">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-2">Investment</p>
                ...
                <p class="text-gray-600 text-sm mt-3">One-time payment • Lifetime access</p>
            </div>

            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6">
                <h3 class="font-semibold text-gray-900 mb-3">What's Included</h3>
                <ul class="space-y-2 text-sm text-gray-700">
                    <li class="flex gap-2"><span class="text-emerald-600">•</span> Full video course</li>
                    <li class="flex gap-2"><span class="text-emerald-600">•</span> Resource files & assets</li>
                    <li class="flex gap-2"><span class="text-emerald-600">•</span> Community access</li>
                    <li class="flex gap-2"><span class="text-emerald-600">•</span> Certification</li>
                </ul>
            </div>
        </div>
        ...
        @if($referralProcessed && $referringPartner)
            <div class="mt-8 p-6 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-200">
                <p class="text-sm text-emerald-900">
                    <span class="font-bold">Referred by {{ $referringPartner->user->name }}</span> — They'll earn a commission on this purchase, creating a win-win partnership.
                </p>
            </div>
        @endif
        ...
        >
            ...
            <button 
                type="submit"
                class="w-full gradient-primary text-white py-4 px-6 rounded-lg font-semibold text-lg btn-modern hover:shadow-xl transition-all"
            >
