...
<div class="network-node relative {{ $depth > 0 ? 'network-node-nested' : '' }}">
    <div class="network-node-content group relative flex max-w-2xl items-center gap-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-md">
    ...
    @if($nodeChildren->isNotEmpty())
        <div class="network-node-children">
