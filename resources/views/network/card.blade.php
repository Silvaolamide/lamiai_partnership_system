...
<div
    class="network-level-card group relative flex w-[360px] shrink-0 items-center gap-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-md"
    data-network-id="{{ $node->id }}"
    data-network-parent="{{ $node->parent_partner_id ?? '' }}"
>
