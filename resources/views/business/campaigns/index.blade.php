<x-app-layout>
<x-slot name="header"><div class="flex items-center justify-between gap-4"><div><h2 class="font-black text-xl text-gray-900">Marketing Campaigns</h2><p class="text-sm text-gray-500 mt-1">Create ad-ready lead funnels and choose where qualified leads go.</p></div><a href="{{ route('business.campaigns.create') }}" class="rounded-xl bg-teal-700 px-5 py-3 text-sm font-black text-white hover:bg-teal-800">+ Create campaign</a></div></x-slot>
