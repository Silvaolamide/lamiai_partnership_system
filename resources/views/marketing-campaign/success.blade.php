...
<body class="min-h-screen bg-[#f3fbfa] text-slate-950">
    <main class="flex min-h-screen items-center justify-center px-5 py-10">
        <section class="w-full max-w-lg text-center">
            ...
            <a id="continue" href="{{ $campaign->redirect_url }}" class="mt-6 inline-flex w-full items-center justify-center rounded-2xl bg-teal-700 px-6 py-4 font-black text-white shadow-lg shadow-teal-700/20 transition hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-200">
                Continue →
            </a>
