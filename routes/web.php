...
Route::middleware(['auth', 'role:super_admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/partners', [AdminPartnerController::class, 'index'])->name('admin.partners.index'); Route::patch('/partners/{partner}/approve', [AdminPartnerController::class, 'approve'])->name('admin.partners.approve'); Route::patch('/admin/partners/{partner}/approve-for-business', [AdminPartnerController::class, 'approveForBusiness'])->name('admin.partners.approve-for-business'); Route::patch('/partners/{partner}/reject', [AdminPartnerController::class, 'reject'])->name('admin.partners.reject');
