...
Route::middleware(['auth', 'role:super_admin'])->prefix('admin')->group(function () {
    ...
    Route::patch('/registrations/{user}/verify-email', [AdminRegistrationController::class, 'verifyEmail'])->name('admin.registrations.verify-email');
    Route::post('/registrations/{user}/resend-verification', [AdminRegistrationController::class, 'resendVerification'])->name('admin.registrations.resend-verification');
    Route::patch('/registrations/{user}/assign-business-role', [AdminRegistrationController::class, 'assignBusinessRole'])->name('admin.registrations.assign-business-role');
    Route::patch('/registrations/{user}/approve', [AdminRegistrationController::class, 'approveBusiness'])->name('admin.registrations.approve');
    Route::patch('/registrations/{user}/reject', [AdminRegistrationController::class, 'rejectBusiness'])->name('admin.registrations.reject');
    Route::patch('/registrations/{user}/repair', [AdminRegistrationController::class, 'repair'])->name('admin.registrations.repair');
    Route::delete('/registrations/{user}', [AdminRegistrationController::class, 'destroy'])->name('admin.registrations.destroy');
