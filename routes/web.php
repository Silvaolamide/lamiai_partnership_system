...
Route::post('/checkout',[CheckoutController::class,'create'])->name('checkout.create'); Route::get('/checkout/{orderId}',[CheckoutController::class,'show'])->name('checkout.show'); Route::get('/checkout/{order}/bank-transfer',[ManualPaymentController::class,'show'])->name('checkout.bank-transfer'); Route::post('/checkout/{order}/bank-transfer',[ManualPaymentController::class,'submit'])->name('checkout.bank-transfer.submit'); Route::post('/checkout/{orderId}/paystack',[CheckoutController::class,'paystack'])->name('checkout.paystack'); Route::post('/checkout/{orderId}/confirm-demo',[CheckoutController::class,'confirm'])->name('checkout.confirm'); Route::get('/checkout/paystack/callback',[CheckoutController::class,'paystackCallback'])->name('checkout.paystack.callback'); Route::post('/webhooks/paystack',[CheckoutController::class,'paystackWebhook'])->name('webhooks.paystack'); Route::get('/order/{orderId}/post-payment',[CheckoutController::class,'postPayment'])->name('order.post-payment');
